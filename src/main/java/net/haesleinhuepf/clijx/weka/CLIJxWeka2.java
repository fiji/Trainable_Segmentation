...
public class CLIJxWeka2 {
    ...
    public CLIJxWeka2(CLIJx clijx, ClearCLBuffer featureStack, ClearCLBuffer classification) {
        this.clijx = clijx;
        this.featureStack = featureStack;
        this.classification = classification;
    }

    public CLIJxWeka2(CLIJx clijx, ClearCLBuffer featureStack, FastRandomForest classifier, Integer numberOfClasses) {
        this.clijx = clijx;
        this.featureStack = featureStack;
    ...
    public CLIJxWeka2(CLIJx clijx, ClearCLBuffer featureStack, String classifierFilename) {
        this.clijx = clijx;
        this.featureStack = featureStack;
