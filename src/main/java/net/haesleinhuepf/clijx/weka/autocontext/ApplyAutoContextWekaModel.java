...
public class ApplyAutoContextWekaModel extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, HasAuthor, HasLicense {
    ...
    public boolean executeCL() {
        ...
        return applyAutoContextWekaModelWithOptions(getCLIJx(), input, prediction, modelFilename, featureDefinitions, numberOfAutoContextIterations);
    }
    ...
    public static boolean applyAutoContextWekaModelWithOptions(CLIJx clijx, ClearCLBuffer input2D, ClearCLBuffer prediction, String saveModelFilename, String featureDefinitions, int numberOfAutoContextIterations) {
        ...
        for (int iterationCount = 0; iterationCount < numberOfAutoContextIterations; iterationCount++) {
            ...
            ApplyOCLWekaModel.applyOCLWekaModel(clijx, feature_stack, prediction, model_filename);
        }
