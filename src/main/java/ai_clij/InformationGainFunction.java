...
public class InformationGainFunction extends ai_clij.SplitFunction
{	
	...
	private static final Comparator<ai_clij.AttributeClassPair> comp = new Comparator<ai_clij.AttributeClassPair>(){
		public int compare(ai_clij.AttributeClassPair o1, ai_clij.AttributeClassPair o2)
		{
	...
	public void init(Instances data, ArrayList<Integer> indices) 
	{
		...
		for(int i=0; i < numOfFeatures; i++)
		{
			...
			final ArrayList<ai_clij.AttributeClassPair> list = new ArrayList<ai_clij.AttributeClassPair>();
