...
{		
	 ...
	 */
	public ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics> getPrecisionRecallStats(
			double minThreshold,
			double maxThreshold,
			double stepThreshold )
	{
		...
		ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics> cs = new ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics>();
	 ...
	 */
	public trainableSegmentation_clij.metrics.ClassificationStatistics getPrecisionRecallStats(double binaryThreshold )
	{
		final ImageStack labelSlices = originalLabels.getImageStack();
		final ImageStack proposalSlices = proposedLabels.getImageStack();
		...
		final ArrayList< Future<trainableSegmentation_clij.metrics.ClassificationStatistics> > futures = new ArrayList< Future<trainableSegmentation_clij.metrics.ClassificationStatistics> >();
		...
		try{
			...
			// Wait for the jobs to be done
			for(Future<trainableSegmentation_clij.metrics.ClassificationStatistics> f : futures)
			{
				trainableSegmentation_clij.metrics.ClassificationStatistics cs = f.get();
		...
		return new trainableSegmentation_clij.metrics.ClassificationStatistics( tp, tn, fp, fn, pixelError / labelSlices.getSize() );
	}
	 ...
	 */
	public trainableSegmentation_clij.metrics.ClassificationStatistics[] getPrecisionRecallStatsPerSlice(final double binaryThreshold )
	{
		final ImageStack labelSlices = originalLabels.getImageStack();
		final ImageStack proposalSlices = proposedLabels.getImageStack();

		final trainableSegmentation_clij.metrics.ClassificationStatistics[] cs = new trainableSegmentation_clij.metrics.ClassificationStatistics[ originalLabels.getImageStackSize() ];
	 ...
	 * @return pixel error value and derived statistics
	 */
	public trainableSegmentation_clij.metrics.ClassificationStatistics getPrecisionRecallStats(
	 ...
	 * @return pixel error value and derived statistics
	 */
	public  Callable<trainableSegmentation_clij.metrics.ClassificationStatistics> getPrecisionRecallStatsConcurrent(
			final ImageProcessor image1, 
			final ImageProcessor image2,
			final double binaryThreshold) 
	{
		return new Callable<trainableSegmentation_clij.metrics.ClassificationStatistics>()
		{
			public trainableSegmentation_clij.metrics.ClassificationStatistics call()
			{				
	 ...
	 */
	public trainableSegmentation_clij.metrics.ClassificationStatistics precisionRecallStats(
			...
			double binaryThreshold)
	{
		...
		return new trainableSegmentation_clij.metrics.ClassificationStatistics(truePositives, trueNegatives, falsePositives, falseNegatives, pixelError);
	}
	...
	public double getPixelErrorMaximalFScore(
			...
			double stepThreshold )
	{
		ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics> stats = getPrecisionRecallStats( minThreshold, maxThreshold, stepThreshold );
