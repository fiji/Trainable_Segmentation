...
public class Trainable_Segmentation implements PlugIn 
{
	...
	private trainableSegmentation_clij.FeatureStack featureStack = null;
	/** GUI window */
	...
	private trainableSegmentation_clij.RoiListOverlay[] roiOverlay;
	/** current segmentation result overlay */
	private trainableSegmentation_clij.ImageOverlay resultOverlay;
	...
	public Trainable_Segmentation() 
	{
		...
		roiOverlay = new trainableSegmentation_clij.RoiListOverlay[MAX_NUM_CLASSES];
	...
	public void run(String arg) 
	{
		...
		featureStack = new trainableSegmentation_clij.FeatureStack(trainingImage);
	...
	public boolean showSettingsDialog()
	{
		...
		final int rows = (int)Math.round(trainableSegmentation_clij.FeatureStack.availableFeatures.length/2.0);
		gd.addCheckboxGroup(rows, 2, trainableSegmentation_clij.FeatureStack.availableFeatures, oldEnableFeatures);
		...
		final int numOfFeatures = trainableSegmentation_clij.FeatureStack.availableFeatures.length;
	...
	static class ButtonListener implements ActionListener 
	{
		...
		private trainableSegmentation_clij.FeatureStack featureStack;

		public ButtonListener(String title, trainableSegmentation_clij.FeatureStack featureStack)
		{
			this.title = title;
