package trainableSegmentation_clij.unsupervised;
...
import trainableSegmentation_clij.FeatureStackArray;
...
public class Color_Clustering implements PlugIn{
    ...
    private trainableSegmentation_clij.unsupervised.ColorClustering colorClustering = null;
    ...
    private class CustomWindow extends StackWindow
    {
        ...
        CustomWindow(ImagePlus imp) {
            ...
            colorClustering = new trainableSegmentation_clij.unsupervised.ColorClustering(image);
            final ImageCanvas canvas = (ImageCanvas) getCanvas();

            // === Channel panel ===
            // read number of available channels from ColorClustering class
            numChannels = trainableSegmentation_clij.unsupervised.ColorClustering.Channel.numChannels();
            ...
            String[] channelList = trainableSegmentation_clij.unsupervised.ColorClustering.Channel.getAllLabels();
            ...
            if (someChannelSelected)
            {
                ...
                for (int i = 0; i < numChannels; ++i) {
                    if (selectedChannels[i]) {
                        trainableSegmentation_clij.unsupervised.ColorClustering.Channel channel = trainableSegmentation_clij.unsupervised.ColorClustering.Channel.fromLabel(ColorClustering.Channel.getAllLabels()[i]);
