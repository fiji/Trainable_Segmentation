...
public class FeatureStackArray 
{
	...
	private trainableSegmentation_clij.FeatureStack[] featureStackArray;
	...
	{
		this.featureStackArray = new trainableSegmentation_clij.FeatureStack[ num ];
	}
	...
	{
		this.featureStackArray = new trainableSegmentation_clij.FeatureStack[ inputImage.getImageStackSize() ];
		
		
		for(int i=1; i <= featureStackArray.length; i++)
		{		
			featureStackArray[ i-1 ] = new trainableSegmentation_clij.FeatureStack(new ImagePlus("slice " + i, inputImage.getImageStack().getProcessor(i)));
	 ...
	 */
	public trainableSegmentation_clij.FeatureStack get(int n)
	{
	 ...
	 */
	public void set(trainableSegmentation_clij.FeatureStack fs, int index)
	{
