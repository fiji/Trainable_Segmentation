...
import trainableSegmentation_clij.metrics.ClassificationStatistics;
...
public final class Utils {
	...
	public static void plotPrecisionRecall(
			ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics> stats)
	{
			...
			ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics> stats)
	{
	   ...
	   */
	  public static double getROCArea(ArrayList<trainableSegmentation_clij.metrics.ClassificationStatistics> stats)
	  {
		  final int n = stats.size();
		  double area = 0;
	...
	public static double getKappa(
			trainableSegmentation_clij.metrics.ClassificationStatistics stats)
	{
